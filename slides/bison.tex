...
\centering\small
  \begin{tikzpicture}[>=latex]
    ...
    \node (three) [right of=plus] {{\tt 3}};
    \node (times) [right of=three] {{\tt *}};
    \node (five) [right of=times] {{\tt 5}};
    \node (nl) [right of=five] {{\tt '$\backslash$n'}};
    \only<-3>{
    ...
    \only<13>{
      \node (pointer) [below of=three] {$15$};
    }
    \only<14->{
      \node (pointer) [below of=three] {$17$};
    }
  ...
  \begin{tabular}[h]{r|l|l|c|l}
    ...
    \only<2->{
    (2) & 0 1 &   {\bf digit} &\hfill + {\bf digit} * {\bf digit}\$ & reduz: $F\rightarrow$ {\bf digit} \\
    }
    \only<3->{
    (3) & 0 6 &   $F$ &\hfill + {\bf digit} * {\bf digit}\$ & reduz: $F\rightarrow T$ \\
    }
    \only<4->{
    (4) & 0 5 &   $T$ &\hfill + {\bf digit} * {\bf digit}\$ & reduz: $T\rightarrow E$ \\
    }
    \only<5->{
    (5) & 0 4 &   $E$ &\hfill + {\bf digit} * {\bf digit}\$ & desloca \\
    }
    \only<6->{
    (6) & 0 4 10&   $E+$ &\hfill {\bf digit} * {\bf digit}\$ & desloca \\
    }
    \only<7->{
    (7) & 0 4 10 1&   $E+$ {\bf digit} &\hfill  * {\bf digit}\$ & reduz: $F\rightarrow$ {\bf digit} \\
    }
    \note{aqui lookahead no * para decidir a próxima ação}
    \only<8->{
    (8) & 0 4 10 6 &   $E+F$ &\hfill  * {\bf digit}\$ & reduz: $T\rightarrow F$ \\
    }
    \only<9->{
    (9) & 0 4 10 13 &   $E+T$ &\hfill  * {\bf digit}\$ & desloca \\}
    \note{aqui lookahead no digit para decidir a próxima ação}
    \only<10->{
    (10) & 0 4 10 13 11 &   $E+T*$ &\hfill {\bf digit}\$ & desloca \\
    }
    \only<11->{
    (11) & 0 4 10 13 11 1&   $E+T*${\bf digit} &\hfill \$ & reduz: $F\rightarrow$ {\bf digit} \\
    }
    \only<12->{
    (12) & 0 4 10 13 11 14&   $E+T*F$ &\hfill \$ & reduz: $T\rightarrow T*F$ \\
    }
    \note{aqui lookahead no newline para decidir a próxima ação}
    \only<13->{
    (13) & 0 4 10 13&   $E+T$ &\hfill \$ & reduz: $E\rightarrow E+T$ \\
    }
    \only<14->{
    (14) & 0 4 &   $E$ &\hfill \$ & desloca {\tt '$\backslash$n'} \\
    }
    \only<15->{
    (15) & 0 4 9 &   $E${\tt '$\backslash$n'} &\hfill \$ & reduz: $L\rightarrow E${\tt '$\backslash$n'} \\
    }
    \only<16>{
    (16) & 0  &   $L$ &\hfill \$ & aceita \\
    }
