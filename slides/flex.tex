...
\begin{frame}[fragile]{Por que autômato finito?}
  { \hfil Comparação entre implementações de expressões regulares}
  \bigskip
 \begin{figure}
  \centering
  \includegraphics[scale=.5]{lex-afd-cox.png}
  \end{figure}
  \vfill
  {\scriptsize Fonte: \href{https://swtch.com/~rsc/regexp/regexp1.html}{Regular Expression Matching Can Be Simple And Fast} by Russ Cox.}
\end{frame}
