...
\begin{frame}{Exemplo - especificação flex}{$\mu$Pascal}
  \center
  \begin{tabular}{rrl}
    {\bf if} & $\rightarrow$ & {\tt if} \\
    {\bf then} & $\rightarrow$ & {\tt then} \\
...
\begin{frame}{Exemplo - especificação flex, cont.}{$\mu$Pascal}
  \small
  \center
  \begin{tabular}{c|c|c}
    \toprule
...
delim                [ \t\n]
ws                   {delim}+ /* espaço em branco */
letter               [A-Za-z] /* letra */
digit                [0-9]
id                   (letter)((letter)|(digit))*
num                  (digit)+(\. (digit)+)?
%%
{ws}                /* nada é retornado ao parser */
if                  {return IF;}
then                {return THEN;}
else                {return ELSE;}
